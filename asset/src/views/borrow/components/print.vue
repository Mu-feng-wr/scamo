    ...
    <el-form ref="form" :model="form" label-width="95px" label-suffix="：" class="bg-white">
      <div id="printWrap" ref="demo" class="print_obj bgClass">
        ...
        <el-card class="box-card" style="page-break-after: always">
          ...
          <div slot="header" class="clearfix text-tip">{{ $vxe.toDateString(printData.borrowDate,'yyyy')+'年'+$vxe.toDateString(printData.borrowDate,'MM')+'月' }}资产借用出库签收单</div>

          <el-row>
            <el-col :span="8">
              <el-form-item label="借用单号">{{ printData.assetBorrowCode }}</el-form-item>
            </el-col>
            <el-col :span="8">
          ...
          <table class="el-table">
            ...
            <tbody>
              <tr v-for="(item, index) in printData.almAssetBorrowDetailList" :key="index">
              ...
              <template v-if="printData.almAssetBorrowDetailList && printData.almAssetBorrowDetailList.length < 3">
                <tr>
