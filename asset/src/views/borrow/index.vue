  ...
  data() {
    return {
      ...
      tableColumn: [
        ...
        { visible: true, field: 'assetBorrowCode', title: '借用单号', fixed: 'left', width: 140, visibleDisabled: true, slots: { default: 'assetBorrowCode' } },
        ...
        { visible: true, field: 'assetQuantity', title: '资产数量', headerAlign: 'center', align: 'right', formatter: 'formatMoney', width: 130 },
        { visible: true, field: 'assetAmount', title: '资产含税金额（元）', headerAlign: 'center', align: 'right', formatter: 'formatMoney', width: 150 },
        { visible: true, field: 'userName', title: '使用人', width: 120 },
        { visible: true, field: 'userOrgName', title: '使用部门', width: 160 },
        { visible: true, field: 'borrowReason', title: '借用原因', width: 220, headerAlign: 'center', align: 'left' },
