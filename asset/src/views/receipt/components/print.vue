<template>
  <vxe-modal v-model="visible" v-loading="submitLoading" title="预览" :close-on-click-modal="false" height="80%" width="800px" @hide="close">
    <div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td ref="remarks" colspan="5">
                  <div :style="{width:remarksWidth+'px'}" class="u-line-1">{{ printData.receiptReason }}</div>
                  <div>{{ getRecords() }}</div>
                </td>
              </tr>
            </tbody>
