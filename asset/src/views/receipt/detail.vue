  ...
  <PageCard v-loading="submitLoading" return-url="/asset/receipt">
    <el-form ref="form" label-width="170px" class="form-table" style="margin-bottom: 8px">
      <SectionCard title="基本信息">
        <el-row>
          <el-col :span="8">
            <el-form-item label="验收单号">{{ formData.assetReceiptCode }}</el-form-item>
          </el-col>
          <el-col :span="8">
      ...
      <SectionCard class="mt-8" title="申请信息">
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="资产所属仓库名称">{{ formData.warehouseName }}</el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="资产所属公司名称">{{ formData.assetCompanyName }}</el-form-item>
          </el-col>
          <el-col :span="8">
      ...
      <SectionCard class="mt-8" title="资产明细">
        <assetReceiptDetail ref="assetDetail" :form-data="formData" :show-btn="false" />
      </SectionCard>
