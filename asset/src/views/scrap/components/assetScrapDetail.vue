<template>
  <div>
    <div class="pt-10 mb-10">
      ...
      <!-- <Pint v-if="!showBtn" v-bind="{selectRows}" :disabled="btnDisabled" class="mr-10"></Pint> -->
      <el-button :disabled="tableData.length==0" size="mini" icon="el-icon-download" @click="handleExport">导出</el-button>
      <el-button v-if="showBtn" size="mini" type="danger" :disabled="btnDisabled" icon="el-icon-delete" plain @click="handleDeleteBatch">删除</el-button>
    </div>
    <vxe-grid
      ref="xTable"
      v-loading="loading"
