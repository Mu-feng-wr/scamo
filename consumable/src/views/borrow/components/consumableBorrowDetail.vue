...
export default {
  ...
  computed: {
    ...
    standBookQuery() {
      return [
        { labelName: 'centralizedBusinessName', valueName: 'centralizedBusinessId', label: this.formData.centralizedBusinessName, value: this.formData.centralizedBusinessId, name: '业务类别', require: true }
      ]
    }
  },
  watch: {
  ...
  methods: {
    ...
    selectStandbookHandler(list) {
      this.tableData = list.map((item) => {
        ...
        this.$set(item, 'schemeId', this.formData.schemeId)
