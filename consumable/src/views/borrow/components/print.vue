    ...
    <el-form ref="form" :model="form" label-width="95px" label-suffix="：" class="bg-white">
      <div id="printWrap" ref="demo" class="print_obj bgClass">
        ...
        <el-card class="box-card" style="page-break-after: always">
          ...
          <div slot="header" class="clearfix text-tip">{{ $vxe.toDateString(printData.borrowDate,'yyyy')+'年'+$vxe.toDateString(printData.borrowDate,'MM')+'月' }}耗材借用出库签收单</div>

          <el-row>
            <el-col :span="8">
              <el-form-item label="借用单号">{{ printData.consumableBorrowCode }}</el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="借用日期">{{ printData.borrowDate }}</el-form-item>
            </el-col>
            <el-col :span="8">
          ...
          <table class="el-table">
            ...
            <tbody>
              <tr v-for="(item, index) in printData.clmConsumableBorrowDetailList" :key="index">
              ...
              <template v-if="printData.clmConsumableBorrowDetailList && printData.clmConsumableBorrowDetailList.length < 3">
                <tr>
              ...
              <tr>
                <td>情况说明</td>
                <td colspan="5">
                  <div class="u-line-1">{{ printData.borrowReason }}</div>
