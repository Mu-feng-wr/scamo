  ...
  computed: {
    tableColumn() {
      return [
        ...
        { showOverflow: true, field: 'assetCode', title: '耗材编号', width: 160 },
        { showOverflow: true, field: 'assetName', title: '耗材名称', width: 160 },
        { showOverflow: true, field: 'categoryName', title: '耗材分类', width: 130 },
        { showOverflow: true, field: 'pictureName', title: '耗材图片', width: 130 },
        ...
        { showOverflow: true, field: 'inventoryQuantity', title: '可派数量', width: 130 },
        // { showOverflow: true, field: 'returnQuantity', title: '借用数量', width: 130 },
        { showOverflow: true, field: 'returnQuantity', title: '本次派发数量', width: 130 },
        ...
        { showOverflow: true, field: 'firstShelfName', title: '存放货架', width: 130 },
        { showOverflow: true, field: 'assetCharacteristic', title: '耗材特性', width: 130 },
        { showOverflow: true, field: 'assetPhysicalState', title: '耗材物态', width: 130 },
        ...
        { field: 'ynInviteTender', title: '招标耗材编码', width: 130 },
