  ...
  <PageCard v-loading="submitLoading" :return-url="returnUrl">
    <el-form ref="form" :disabled="!editForm" :model="formData" :rules="rules" label-width="170px" class="form-table form-table-edit" style="margin-bottom: 8px">
      <SectionCard title="基本信息">
        <el-row>
          <el-col :span="8">
            <el-form-item label="耗材验收单号" prop="consumableReceiptCode">
              <el-input v-model="formData.consumableReceiptCode" size="small" disabled placeholder="系统自动生成" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
          ...
          <el-col :span="8">
            <el-form-item label="业务类别" prop="centralizedBusinessId">
              <base-input
                size="small"
                :disabled="formData.ynGenLine==1||!!formData.consumableReceiptId"
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="验收日期" prop="registeDate">
              <el-date-picker v-model="formData.registeDate" size="small" clearable type="date" value-format="yyyy-MM-dd HH:mm:ss" placeholder="请选择验收日期" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
          ...
          <el-col :span="8">
            <el-form-item label="耗材所属仓库名称" prop="warehouseName">
              <base-input
                size="small"
          ...
          <el-col :span="8">
            <el-form-item label="耗材所属公司名称" prop="assetCompanyName">
    ...
    <div slot="footer" align="center">
      <el-button v-if="formData.ynGenLine==0||!formData.ynGenLine" type="primary" @click="generateReceiptAssetCode(0,1)">保存生成耗材编码</el-button>
      <el-button v-if="(!formData.status||formData.status==0)&&formData.ynGenLine!=1" type="primary" @click="submitForm(0)">保存继续录入耗材明细</el-button>
    ...
    <purchaseApplication
      ...
      :query="[{label:'centralizedBusinessId',value:formData.centralizedBusinessId},{label:'materialType',value:'2'}]"
  ...
  data() {
    return {
      ...
      rules: {
        ...
        warehouseName: { required: true, message: '耗材仓库不能为空', trigger: 'change' },
