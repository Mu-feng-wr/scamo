    ...
    <el-form ref="form" :model="form" label-width="95px" label-suffix="：" class="bg-white">
      <div id="printWrap" ref="demo" class="print_obj bgClass">
        ...
        <el-card class="box-card" style="page-break-after: always">
          ...
          <div slot="header" class="clearfix text-tip">{{ $vxe.toDateString(printData.returnDate,'yyyy')+'年'+$vxe.toDateString(printData.returnDate,'MM')+'月' }}资产归还入库确认单</div>

          <el-row>
            <el-col :span="8">
              <el-form-item label="归还单号">{{ printData.consumableReturnCode }}</el-form-item>
            </el-col>
            <el-col :span="8">
