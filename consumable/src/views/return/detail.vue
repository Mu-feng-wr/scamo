  ...
  <PageCard v-loading="submitLoading">
    <el-form ref="form" label-width="170px" class="form-table" style="margin-bottom: 8px">
      <SectionCard title="基本信息">
        <el-row>
          <el-col :span="8">
            <el-form-item label="归还单号">{{ formData.consumableReturnCode }}</el-form-item>
          </el-col>
          <el-col :span="8">
      ...
      <SectionCard title="申请信息" class="mt-8">
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="耗材数量">{{ $vxe.commafy(formData.consumableQuantity,{digits:2}) }}</el-form-item>
          </el-col>
          <el-col :span="8">
          ...
          <el-col :span="8">
            <el-form-item label="单据来源">
              <dictDateView :value="formData.billSource" :dict-data-list="dictDataList" dict-code="ClmConsumableReturn-billSource" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
    ...
    <SectionCard title="耗材明细">
      <consumableReturnDetail ref="consumableReturnDetail" :form-data="formData" :show-btn="false" />
    </SectionCard>
