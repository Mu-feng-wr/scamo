        ...
        <SearchArea :show-all-search.sync="showAllSearch" class="p-16">
          <div class="flex">
            <div class="searchLeft">
              <el-row :gutter="14">
                <el-col :span="4">
                  <el-input v-model="queryParams.consumableTransferCode" size="mini" placeholder="调拨单号" clearable />
                </el-col>
                <el-col :span="4">
          ...
          <el-main>
            ...
            >
              ...
              <template v-slot:todo="{ row }">
                <div class="todo">
                  <el-button size="mini" type="text" @click="detailHandle(row.consumableTransferId)">查看</el-button>
                  <el-button v-hasPermi="['asset:receipt:edit']" size="mini" type="text" @click="addOrUpdateHandle(row.consumableTransferId)">修改</el-button>
...
export default {
  ...
  data() {
    return {
      ...
      tableColumn: [
        ...
        { visible: true, field: 'consumableTransferCode', title: '调拨单号', fixed: 'left', width: 160, visibleDisabled: true },
        ...
        { visible: true, field: 'transferQuantity', title: '耗材数量', width: 130, headerAlign: 'center', align: 'right', formatter: 'formatMoney' },
        { visible: true, field: 'transferAmount', title: '耗材金额（元）', width: 150, headerAlign: 'center', align: 'right', formatter: 'formatMoney' },
        ...
        { visible: true, field: 'projectCode', title: '调出项目编号', width: 130 },
        { visible: true, field: 'projectName', title: '调出项目名称', width: 130 },
      ...
      filterOptions: [
        ...
        { label: '调出项目名称：', type: 'baseInput', baseCode: 'listContract', labelName: 'contractName', valueName: 'contractId', value: 'contractId' },
        { label: '调入项目名称：', type: 'baseInput', baseCode: 'listContract', labelName: 'contractName', valueName: 'contractId', value: 'contractId' },
  ...
  methods: {
    ...
    getFooterData({ columns, data }) {
      return this.footerMethod(columns, data, '', ['transferQuantity', 'transferAmount'])
    },
    // 获取字典数据
    getDictData() {
