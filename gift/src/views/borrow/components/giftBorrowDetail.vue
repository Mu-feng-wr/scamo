<template>
  <div>
    <div v-if="showBtn" class="pt-10 mb-10">
      ...
      <el-button v-if="showBtn" icon="el-icon-delete" type="danger" size="mini" @click="handleDeleteBatch">删除</el-button>
    </div>
    <vxe-grid
      ref="xTable"
      v-loading="loading"
  ...
  computed: {
    tableColumn() {
      return [
        ...
        { showOverflow: true, field: 'assetCode', title: '礼品编码', width: 160, fixed: 'left' },
        { showOverflow: true, field: 'assetName', title: '礼品名称', width: 160, fixed: 'left' },
        { showOverflow: true, field: 'categoryName', title: '礼品分类', width: 160, fixed: 'left' },
        { showOverflow: true, field: 'pictureName', title: '礼品图片', width: 160 },
        { showOverflow: true, field: 'serialNum', title: '序列号', width: 160 },
        { showOverflow: true, field: 'specificationModel', title: '规格型号', width: 160 },
        { showOverflow: true, field: 'brandName', title: '品牌', width: 130 },
        { showOverflow: true, field: 'inventoryQuantity', title: '库存数量', width: 130 },
        ...
        { showOverflow: true, field: 'priceExcludTax', title: '不含税单价（元）', width: 140, headerAlign: 'center', align: 'right', formatter: 'formatMoney' },
        { showOverflow: true, field: 'taxRate', title: '税率（%）', width: 130, headerAlign: 'center', align: 'right', formatter: 'formatMoney' },
        ...
        { showOverflow: true, field: 'subtotal', title: '金额小计', width: 130, headerAlign: 'center', align: 'right', formatter: 'formatMoney' },
        // { showOverflow: true, field: 'discountAmount', title: '优惠金额（元）', width: 130, slots: { edit: 'discountAmount' }, editRender: {}, headerAlign: 'center', align: 'right', formatter: 'formatMoney' },
        { showOverflow: true, field: 'currentUserName', title: '使用人', width: 160, slots: { edit: 'currentUserName' }, editRender: {} },
        { showOverflow: true, field: 'currentOrgName', title: '使用部门', width: 130 },
        { showOverflow: true, field: 'currentEreaName', title: '使用区域', width: 180 },
        { showOverflow: true, field: 'currentLocationName', title: '具体位置', width: 160, slots: { edit: 'currentLocationName' }, editRender: {} },
        { showOverflow: true, field: 'firstShelfName', title: '存放货架', width: 160, slots: { default: 'firstShelfName' } },
        ...
        // { showOverflow: true, field: 'remarks', title: '备注', width: 200, slots: { edit: 'remarks' }, editRender: {} },
