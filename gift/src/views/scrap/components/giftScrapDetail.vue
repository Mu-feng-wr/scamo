  ...
  computed: {
    tableColumn() {
      return [
        ...
        { field: 'inventoryQuantity', title: '库存数量', width: 130 },
        { field: 'returnQuantity', title: '终结数量', width: 130 },
        ...
        { field: 'priceExcludTax', title: '收回残值（元）', width: 160, headerAlign: 'center', align: 'right', formatter: 'formatMoney' },
