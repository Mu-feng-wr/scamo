...
<script>
import { listReport, delReport } from '@/api/report'
  ...
  data() {
    return {
      ...
      tableColumn: [
        ...
        { visible: true, field: 'planCode', title: '盘点单号', width: 130, fixed: 'left', visibleDisabled: true },
        { visible: true, field: 'planTitle', title: '盘点标题', width: 130, fixed: 'left', visibleDisabled: true },
        ...
        { visible: true, field: 'planTitle', title: '盘点标题', width: 130 },
        ...
        { visible: true, field: 'cycleInventory', title: '盘点周期', width: 130 },
        { visible: true, field: 'coverageRange', title: '覆盖范围', width: 130 },
        { visible: true, field: 'coverageDate', title: '覆盖数据', width: 130 },
        { visible: true, field: 'ynSelfInventory', title: '是否自盘', width: 130 },
        { visible: true, field: 'offereQuantity', title: '应盘数量', width: 130 },
        ...
        { visible: true, field: 'offereAssetTotalAmount', title: '盘点总金额（元）', width: 150 },
        { visible: true, field: 'startDate', title: '开始日期', width: 130 },
        { visible: true, field: 'endDate', title: '结束日期', width: 130 },
        { visible: true, field: '', title: '盘点原因', width: 130 },
