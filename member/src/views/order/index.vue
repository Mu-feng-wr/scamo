      ...
      <el-main style="padding:0;">
        <el-container>
          <el-header>
            <el-row class="mb-15">
              <el-col :span="12">
                <el-button v-hasPermi="['asset:borrow:add']" type="primary" plain icon="el-icon-plus" size="mini" @click="addOrUpdateHandle()">新增订单</el-button>
...
import { findListByCondition } from '@/api/order.js'
  ...
  data() {
    return {
      ...
      tableColumn: [
        ...
        { visible: true, field: 'orderVersionId', title: '订购版本id', width: 150, fixed: 'left', visibleDisabled: true },
        { visible: true, field: 'versionSaleId', title: '在售版本id', width: 130, fixed: 'left', visibleDisabled: true },
        { visible: true, field: 'customerId', title: '客户id', width: 130, fixed: 'left', visibleDisabled: true },
        { visible: true, field: 'orderDate', title: '订购时间', width: 130 },
        { visible: true, field: 'annualPurchaseVolume', title: '购买年量', width: 130 },
        { visible: true, field: 'includTaxPrice', title: '订购含税单价（元）', width: 170, headerAlign: 'center', align: 'left' },
        { visible: true, field: 'taxValue', title: '税额单价（元）', width: 130, headerAlign: 'center', align: 'right', formatter: 'formatMoney' },
        { visible: true, field: 'taxRate', title: '税率（%）', width: 160, headerAlign: 'center', align: 'right' },
        { visible: true, field: 'subtotalAmount', title: '小计（元）', width: 130, formatter: 'formatMoney' },
        { visible: true, field: 'payDate', title: '支付日期', width: 130 },
        { visible: true, field: 'ynFinishPay', title: '是否已完成支付', width: 240, headerAlign: 'center', align: 'left' },
        { visible: true, field: 'versionExpirationDate', title: '版本到期时间', width: 160, headerAlign: 'center', align: 'right' },
        { visible: true, field: 'unifiedSystemNumber', title: '客户统一系统编号', width: 130 },
        { visible: true, field: 'remarks', title: '备注', width: 200, headerAlign: 'center', align: 'left' },
        { visible: true, field: 'createDate', title: '创建时间', width: 200, headerAlign: 'center', align: 'left' },
